...
Shader "BOXOPHOBIC/The Vegetation Engine/Objects/Prop Standard Lit (projection)"
{
	Properties
	{
		[StyledBanner(Prop Standard Lit, (projection))]_Banner("Banner", Float) = 0
		...
		[HideInInspector]_IsProjectionShader("_IsProjectionShader", Float) = 1
	...
	SubShader
	{
		...
		uniform half _IsProjectionShader;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			#endif
			float3 Mesh_PivotsOS2291_g22690 = staticSwitch14_g23099;
			float Vertex_SizeFade1740_g22690 = 1.0;
			half Vertex_Size1741_g22690 = 1.0;
			float3 Final_VertexPosition890_g22690 = ( ( ( ( ase_vertex3Pos - Mesh_PivotsOS2291_g22690 ) * Vertex_SizeFade1740_g22690 * Vertex_Size1741_g22690 ) + Mesh_PivotsOS2291_g22690 ) + ( _IsStandardPipeline * 0.0 ) );
			v.vertex.xyz = Final_VertexPosition890_g22690;
			v.vertex.w = 1;
		}

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			half2 Main_UVs15_g22690 = ( ( i.uv_texcoord * (_MainUVs).xy ) + (_MainUVs).zw );
			float4 tex2DNode117_g22690 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g22690 );
			float2 appendResult88_g23117 = (float2(tex2DNode117_g22690.a , tex2DNode117_g22690.g));
			...
			float3 Main_Normal137_g22690 = appendResult91_g23117;
			float3 ase_worldPos = i.worldPos;
			half2 Second_UVs17_g22690 = ( ( (ase_worldPos).xz * (_SecondUVs).xy ) + (_SecondUVs).zw );
			float4 tex2DNode145_g22690 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondAlbedoTex, Second_UVs17_g22690 );
			float2 appendResult88_g23080 = (float2(tex2DNode145_g22690.a , tex2DNode145_g22690.g));
			...
			float3 Second_Normal179_g22690 = appendResult91_g23080;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 lerpResult1537_g22690 = lerp( float3(0,1,0) , float3(0,-1,0) , _DetailProjectionMode);
			float dotResult1532_g22690 = dot( ase_worldNormal , lerpResult1537_g22690 );
			half Blend_Source1540_g22690 = ( ( dotResult1532_g22690 * 0.5 ) + _DetailMeshValue );
			float4 tex2DNode35_g22690 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g22690 );
			half Main_Mask57_g22690 = tex2DNode35_g22690.b;
			float4 tex2DNode33_g22690 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_SecondAlbedoTex, Second_UVs17_g22690 );
			half Second_Mask81_g22690 = tex2DNode33_g22690.b;
			float lerpResult1327_g22690 = lerp( Main_Mask57_g22690 , Second_Mask81_g22690 , _MaskMode);
			float temp_output_7_0_g23111 = _DetailMaskContrast;
			half Autoregister_DetailMode667_g22690 = ( _DetailMode * _DetailShadingCat );
			half Mask_Detail147_g22690 = ( saturate( ( ( saturate( ( Blend_Source1540_g22690 + ( Blend_Source1540_g22690 * ( ( ( 1.0 - lerpResult1327_g22690 ) - 0.5 ) + _DetailMaskValue ) ) ) ) - temp_output_7_0_g23111 ) / ( ( 1.0 - _DetailMaskContrast ) - temp_output_7_0_g23111 ) ) ) + Autoregister_DetailMode667_g22690 );
			float3 lerpResult230_g22690 = lerp( float3( 0,0,1 ) , Second_Normal179_g22690 , Mask_Detail147_g22690);
			float3 lerpResult249_g22690 = lerp( Main_Normal137_g22690 , Second_Normal179_g22690 , Mask_Detail147_g22690);
			#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch267_g22690 = Main_Normal137_g22690;
			#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch267_g22690 = BlendNormals( Main_Normal137_g22690 , lerpResult230_g22690 );
			#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch267_g22690 = lerpResult249_g22690;
			#else
				float3 staticSwitch267_g22690 = Main_Normal137_g22690;
			#endif
			float3 temp_output_13_0_g23120 = staticSwitch267_g22690;
			float3 switchResult12_g23120 = (((i.ASEVFace>0)?(temp_output_13_0_g23120):(( temp_output_13_0_g23120 * _render_normals_options ))));
			half3 Blend_Normal312_g22690 = switchResult12_g23120;
			...
			half3 Global_OverlayNormal313_g22690 = temp_output_84_19_g23102;
			float3 Blend_NormalRaw1051_g22690 = staticSwitch267_g22690;
			float3 switchResult1063_g22690 = (((i.ASEVFace>0)?(Blend_NormalRaw1051_g22690):(( Blend_NormalRaw1051_g22690 * float3(-1,-1,-1) ))));
			half Overlay_Contrast1405_g22690 = _OverlayContrast;
			float3 appendResult1439_g22690 = (float3(Overlay_Contrast1405_g22690 , Overlay_Contrast1405_g22690 , 1.0));
			half Global_OverlayIntensity154_g22690 = TVE_OverlayIntensity;
			...
			half Global_ExtrasTex_B156_g22690 = tex2DNode7_g23128.b;
			float temp_output_1025_0_g22690 = ( Global_OverlayIntensity154_g22690 * _GlobalOverlay * Global_ExtrasTex_B156_g22690 );
			half Overlay_Commons1365_g22690 = temp_output_1025_0_g22690;
			half Overlay_Mask269_g22690 = saturate( ( saturate( (WorldNormalVector( i , ( switchResult1063_g22690 * appendResult1439_g22690 ) )).y ) - ( 1.0 - Overlay_Commons1365_g22690 ) ) );
			float3 lerpResult349_g22690 = lerp( Blend_Normal312_g22690 , Global_OverlayNormal313_g22690 , Overlay_Mask269_g22690);
			half3 Final_Normal366_g22690 = lerpResult349_g22690;
			o.Normal = Final_Normal366_g22690;
			float4 tex2DNode29_g22690 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g22690 );
			float4 temp_output_51_0_g22690 = ( _MainColor * tex2DNode29_g22690 );
			half3 Main_AlbedoRaw99_g22690 = (temp_output_51_0_g22690).rgb;
			half3 Main_AlbedoColored863_g22690 = Main_AlbedoRaw99_g22690;
			half3 Second_Albedo153_g22690 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g22690 ) )).rgb;
			half3 Second_AlbedoColored1963_g22690 = Second_Albedo153_g22690;
			#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g23121 = 2.0;
			#else
				float staticSwitch1_g23121 = 4.594794;
			#endif
			float3 lerpResult235_g22690 = lerp( Main_AlbedoColored863_g22690 , ( Main_AlbedoColored863_g22690 * Second_AlbedoColored1963_g22690 * staticSwitch1_g23121 ) , Mask_Detail147_g22690);
			float3 lerpResult208_g22690 = lerp( Main_AlbedoColored863_g22690 , Second_AlbedoColored1963_g22690 , Mask_Detail147_g22690);
			#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch255_g22690 = Main_AlbedoColored863_g22690;
			#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch255_g22690 = lerpResult235_g22690;
			#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch255_g22690 = lerpResult208_g22690;
			#else
				float3 staticSwitch255_g22690 = Main_AlbedoColored863_g22690;
			#endif
			half3 Blend_Albedo265_g22690 = staticSwitch255_g22690;
			half3 Blend_AlbedoAndSubsurface149_g22690 = Blend_Albedo265_g22690;
			half3 Global_OverlayColor1758_g22690 = (TVE_OverlayColor).rgb;
			half3 Global_OverlayAlbedo277_g22690 = (SAMPLE_TEXTURE2D( TVE_OverlayAlbedoTex, samplerTVE_OverlayAlbedoTex, temp_output_38_0_g23102 )).rgb;
			float3 lerpResult336_g22690 = lerp( Blend_AlbedoAndSubsurface149_g22690 , ( Global_OverlayColor1758_g22690 * Global_OverlayAlbedo277_g22690 ) , Overlay_Mask269_g22690);
			half3 Final_Albedo359_g22690 = lerpResult336_g22690;
			half Main_Alpha316_g22690 = (temp_output_51_0_g22690).a;
			float lerpResult354_g22690 = lerp( 1.0 , Main_Alpha316_g22690 , _render_premul);
			half Final_Premultiply355_g22690 = lerpResult354_g22690;
			o.Albedo = ( Final_Albedo359_g22690 * Final_Premultiply355_g22690 );
			half Main_Metallic237_g22690 = ( tex2DNode35_g22690.r * _MainMetallicValue );
			half Second_Metallic226_g22690 = ( tex2DNode33_g22690.r * _SecondMetallicValue );
			float lerpResult278_g22690 = lerp( Main_Metallic237_g22690 , Second_Metallic226_g22690 , Mask_Detail147_g22690);
			#if defined(MATERIAL_USE_DETAIL_OFF)
				float staticSwitch299_g22690 = Main_Metallic237_g22690;
			#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float staticSwitch299_g22690 = Main_Metallic237_g22690;
			#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float staticSwitch299_g22690 = lerpResult278_g22690;
			#else
				float staticSwitch299_g22690 = Main_Metallic237_g22690;
			#endif
			half Blend_Metallic306_g22690 = staticSwitch299_g22690;
			float lerpResult342_g22690 = lerp( Blend_Metallic306_g22690 , 0.0 , Overlay_Mask269_g22690);
			half Final_Metallic367_g22690 = lerpResult342_g22690;
			o.Metallic = Final_Metallic367_g22690;
			half Main_Smoothness227_g22690 = ( tex2DNode35_g22690.a * _MainSmoothnessValue );
			half Second_Smoothness236_g22690 = ( tex2DNode33_g22690.a * _SecondSmoothnessValue );
			float lerpResult266_g22690 = lerp( Main_Smoothness227_g22690 , Second_Smoothness236_g22690 , Mask_Detail147_g22690);
			#if defined(MATERIAL_USE_DETAIL_OFF)
				float staticSwitch297_g22690 = Main_Smoothness227_g22690;
			#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float staticSwitch297_g22690 = Main_Smoothness227_g22690;
			#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float staticSwitch297_g22690 = lerpResult266_g22690;
			#else
				float staticSwitch297_g22690 = Main_Smoothness227_g22690;
			#endif
			half Blend_Smoothness314_g22690 = staticSwitch297_g22690;
			half Global_OverlaySmoothness311_g22690 = TVE_OverlaySmoothness;
			float lerpResult343_g22690 = lerp( Blend_Smoothness314_g22690 , Global_OverlaySmoothness311_g22690 , Overlay_Mask269_g22690);
			half Final_Smoothness371_g22690 = lerpResult343_g22690;
			half Global_Wetness1016_g22690 = ( TVE_Wetness * _GlobalWetness );
			half Global_ExtrasTex_A1033_g22690 = tex2DNode7_g23128.a;
			float lerpResult1037_g22690 = lerp( Final_Smoothness371_g22690 , saturate( ( Final_Smoothness371_g22690 + Global_Wetness1016_g22690 ) ) , Global_ExtrasTex_A1033_g22690);
			o.Smoothness = lerpResult1037_g22690;
			float lerpResult240_g22690 = lerp( 1.0 , tex2DNode35_g22690.g , _MainOcclusionValue);
			half Main_Occlusion247_g22690 = lerpResult240_g22690;
			float lerpResult239_g22690 = lerp( 1.0 , tex2DNode33_g22690.g , _SecondOcclusionValue);
			half Second_Occlusion251_g22690 = lerpResult239_g22690;
			float lerpResult294_g22690 = lerp( Main_Occlusion247_g22690 , Second_Occlusion251_g22690 , Mask_Detail147_g22690);
			#if defined(MATERIAL_USE_DETAIL_OFF)
				float staticSwitch310_g22690 = Main_Occlusion247_g22690;
			#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float staticSwitch310_g22690 = ( Main_Occlusion247_g22690 * Second_Occlusion251_g22690 );
			#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float staticSwitch310_g22690 = lerpResult294_g22690;
			#else
				float staticSwitch310_g22690 = Main_Occlusion247_g22690;
			#endif
			half Blend_Occlusion323_g22690 = staticSwitch310_g22690;
			o.Occlusion = Blend_Occlusion323_g22690;
			o.Alpha = Main_Alpha316_g22690;
			half Main_AlphaRaw1203_g22690 = tex2DNode29_g22690.a;
			half Alpha5_g23106 = Main_AlphaRaw1203_g22690;
			#ifdef _ALPHATEST_ON
				float staticSwitch2_g23106 = Alpha5_g23106;
			#else
				float staticSwitch2_g23106 = 1.0;
			#endif
			half Final_Clip914_g22690 = staticSwitch2_g23106;
			clip( Final_Clip914_g22690 - _Cutoff );
		}
...
/*ASEBEGIN
Version=18500
1927;7;1906;1014;2771.99;1114.869;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-1744,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;175;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2176,-896;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;True;1;StyledBanner(Prop Standard Lit, (projection));False;0;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;349;-2176,-384;Inherit;False;Base Shader;1;;22690;856f7164d1c579d43a5cf4968a75ca43;51,1271,1,1300,1,1298,1,1962,0,1708,0,1712,0,1964,1,1969,1,1723,0,1719,0,893,0,1745,0,1742,0,1715,1,1714,1,1717,1,1728,1,1718,1,916,1,1732,1,1949,1,1763,1,1762,1,1776,0,1646,0,1690,0,1757,0,1669,0,1981,0,1759,0,2172,0,1733,1,1734,1,1736,1,1968,1,1735,1,1737,1,1966,1,1550,2,878,2,860,0,2261,1,2260,1,2032,1,2054,1,2057,1,2033,1,2036,1,2060,1,2062,1,2039,1;0;16;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534;FLOAT3;2075
Node;AmplifyShaderEditor.RangedFloatNode;350;-1344,-896;Half;False;Property;_IsAnyPathShader;_IsAnyPathShader;173;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;127;-1984,-896;Half;False;Property;_IsProjectionShader;_IsProjectionShader;172;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-1520,-896;Half;False;Property;_IsLitShader;_IsLitShader;174;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-1376,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;0;Standard;BOXOPHOBIC/The Vegetation Engine/Objects/Prop Standard Lit (projection);False;False;False;False;False;True;False;True;False;False;False;False;True;False;True;False;True;False;False;False;True;Back;0;True;17;0;False;-1;True;0;False;-1;-1;False;-1;False;0;Custom;0.719;True;True;0;True;Opaque;;Geometry;All;11;d3d11;glcore;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;1;0;True;20;0;True;7;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Absolute;0;;-1;-1;-1;-1;0;False;0;0;True;10;-1;0;True;21;0;0;0;False;0.1;False;-1;0;False;-1;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;1;349;528
WireConnection;0;3;349;529
WireConnection;0;4;349;530
WireConnection;0;5;349;531
WireConnection;0;9;349;532
WireConnection;0;10;349;653
WireConnection;0;11;349;534
ASEEND*/
//CHKSM=64BF5F63C453150E18838F40286DDA00A6061A8D
