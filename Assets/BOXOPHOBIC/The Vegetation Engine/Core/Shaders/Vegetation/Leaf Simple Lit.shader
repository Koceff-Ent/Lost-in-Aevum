...
Shader "BOXOPHOBIC/The Vegetation Engine/Vegetation/Leaf Simple Lit"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half3 Final_Normal366_g22924 = Blend_Normal312_g22924;
			...
			#endif
			float3 lerpResult108_g22924 = lerp( float3( 1,1,1 ) , ( (_LocalColors).rgb * ( Global_ColorsTex_RGB1700_g22924 * staticSwitch1_g23118 ) ) , _GlobalColors);
			...
			float3 lerpResult1698_g22924 = lerp( temp_cast_1 , temp_output_799_0_g22924 , lerpResult1720_g22924);
			...
			half Subsurface_Mask1557_g22924 = 1.0;
			half Overlay_Mask_Subsurface1492_g22924 = 0.0;
			...
			float3 temp_output_13_0_g23123 = float3(0,0,1);
			float3 switchResult12_g23123 = (((i.ASEVFace>0)?(temp_output_13_0_g23123):(( temp_output_13_0_g23123 * _render_normals_options ))));
			float dotResult777_g22924 = dot( normalize( (WorldNormalVector( i , switchResult12_g23123 )) ) , ase_worldlightDir );
			#ifdef UNITY_PASS_FORWARDADD
			...
			float3 lerpResult336_g22924 = lerp( Blend_AlbedoAndSubsurface149_g22924 , Global_OverlayColor1758_g22924 , Overlay_Mask269_g22924);
			...
			float lerpResult1037_g22924 = lerp( _ObjectSmoothnessValue , saturate( ( _ObjectSmoothnessValue + Global_Wetness1016_g22924 ) ) , Global_ExtrasTex_A1033_g22924);
			...
			o.Occlusion = Vertex_Occlusion648_g22924;
...
/*ASEBEGIN
Version=18500
1927;1;1906;1020;2706.583;1048.719;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1921,-767;Half;False;Property;_render_cull;_render_cull;179;0;Fetch;True;3;Both;0;Back;1;Front;2;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;196;-2176,256;Inherit;False;Feature Batching Support;172;;23187;d914b3a554b05ab4da8c1d2a8ce94c0a;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;203;-2176,-384;Inherit;False;Base Shader;1;;22924;856f7164d1c579d43a5cf4968a75ca43;51,1271,0,1300,0,1298,0,1962,1,1708,1,1712,0,1964,1,1969,1,1723,1,1719,1,893,1,1745,1,1742,1,1715,1,1714,1,1717,1,1728,1,1718,1,916,1,1732,1,1949,1,1763,0,1762,0,1776,1,1646,1,1690,1,1757,1,1669,0,1981,0,1759,0,2172,0,1733,0,1734,0,1736,0,1968,0,1735,0,1737,0,1966,0,1550,0,878,0,860,1,2261,1,2260,1,2032,1,2054,1,2057,1,2033,1,2036,1,2060,1,2062,1,2039,1;0;16;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534;FLOAT3;2075
Node;AmplifyShaderEditor.RangedFloatNode;204;-1344,-896;Half;False;Property;_IsAnyPathShader;_IsAnyPathShader;176;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;-1728,-896;Half;False;Property;_IsSimpleShader;_IsSimpleShader;177;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;127;-1920,-896;Half;False;Property;_IsLeafShader;_IsLeafShader;174;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-1376,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;0;Standard;BOXOPHOBIC/The Vegetation Engine/Vegetation/Leaf Simple Lit;False;False;False;False;False;True;False;True;False;False;False;False;True;True;True;False;True;False;False;False;True;Back;0;True;17;0;False;-1;True;0;False;-1;-1;False;-1;False;0;Custom;0.719;True;True;0;True;Opaque;;Geometry;All;11;d3d11;glcore;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;1;0;True;20;0;True;7;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Absolute;0;;-1;-1;-1;-1;0;False;0;0;True;10;-1;0;True;21;0;0;0;False;0.1;False;-1;0;False;-1;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.CommentaryNode;33;-2176,-512;Inherit;False;1022.896;100;Final;0;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;180;-2176,128;Inherit;False;1026.438;100;Features;0;;0,1,0.5,1;0;0
...
WireConnection;0;1;203;528
WireConnection;0;4;203;530
WireConnection;0;5;203;531
WireConnection;0;9;203;532
WireConnection;0;10;203;653
WireConnection;0;11;203;534
ASEEND*/
//CHKSM=9C75996584FC9735480342B7B3A05622A6BF9EBC
