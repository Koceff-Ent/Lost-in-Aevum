...
namespace TheVegetationEngine
{
    public class TVEPrefabSettings : EditorWindow
    {
        ...
        {
        "All", "Motion", "Shading", "Globals", "Subsurface", "Billboard and Grass", "Main", "Misc"
        };
        ...
        List<TVEMaterialData> billboardAndGrassData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_GrassPerspectivePushValue", "Grass Perspective Push", -100, 0, 4, false, true),
            new TVEMaterialData("_GrassPerspectiveNoiseValue", "Grass Perspective Noise", -100, 0, 4, false, false),
            new TVEMaterialData("_GrassPerspectiveAngleValue", "Grass Perspective Angle", -100, 0, 8, false, false),
        };
        ...
        List<TVEMaterialData> mainData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_ObjectMetallicValue", "Object Metallic", -100, 0, 1, false, true),
            new TVEMaterialData("_ObjectOcclusionValue", "Object Occlusion", -100, 0, 8, false, false),
            new TVEMaterialData("_ObjectSmoothnessValue", "Object Smoothness", -100, 0, 1, false, false),
        };

        List<TVEMaterialData> miscData = new List<TVEMaterialData>
        {
            new TVEMaterialData("_LocalColors", "Local Colors", new Color(-100, 0,0,0), true, true),
            new TVEMaterialData("_LocalLeaves", "Local Leaves", -100, 0, 1, false, false),
            new TVEMaterialData("_LocalSize", "Local Size", -100, 0, 1, false, false),
            ...
            //new TVEMaterialData("_OverlayUVTilling", "Overlay Tilling", -100, 0, 10, false, false),
        ...
        void OnEnable()
        {
            ...
            materialData.AddRange(miscData);
        ...
        //    presetIndex = EditorGUILayout.Popup(presetIndex, presetOptions, stylePopup, GUILayout.Width(GUI_HALF_WIDTH - 5), GUILayout.Height(GUI_HEIGHT));

        //    GUILayout.Space(5);

        //    if (GUILayout.Button("Load Preset", GUILayout.Height(GUI_HEIGHT)))
        //    {
        //        GetPresetLines();
